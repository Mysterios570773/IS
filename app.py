...
ml_model_path = os.path.join("..", "models", "employee_attrition_model.pkl")
nn_model_path = os.path.join("..", "models", "diabetes_nn_model_v5.keras")
...
def show_data_preparation():
    ...
    if st.button("Load Employee Attrition Data"):
        df_path = os.path.join("..", "datasets", "employee_attrition.csv")
        df = pd.read_csv(df_path)
        st.dataframe(df.head())
    if st.button("Load Diabetes Data"):
        df_path = os.path.join("..", "datasets", "diabetes.csv")
        df = pd.read_csv(df_path)
        st.dataframe(df.head())
